({
    doInit : function(component, event, helper) {
        ...
        helper.getBGHMemberContacts(component);
    },
    ...
    enableGoBtn : function(component, event, helper) {
        ...
        if(event.getParams().keyCode == 13){                                           
            if(searchKeyText != undefined && searchKeyText != null && searchKeyText.trim().length > 0) {
                ...
                helper.getBGHMemberContacts(component, 1, searchKeyVal, searchFieldVal, operator);
            }            
        } 
    },
    ...
    pageChange: function(component, event, helper) {
        ...
        helper.getBGHMemberContacts(component, page, searchKeyVal, searchFieldVal, operator);
    },
