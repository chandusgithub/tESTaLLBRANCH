({
    getBGHMemberContacts : function(component, page, searchKey, searchFieldVal, operatorVal) {
        ...
        var accountId = component.get('v.Child_Data').accountId;
		var action = component.get("c.getBGHMembersForPopup");
        action.setParams({
        ...
        action.setCallback(this,function(response){
            ...
            if(state == "SUCCESS") {
                if(response.getReturnValue() != null) {
                    ...
                    if((responseObj.contactList == null) || (responseObj.contactList != null && responseObj.contactList.length == 0)) {
                        component.set('v.isBGHMemberListEmpty', true);
                    } else {
                        component.set('v.isBGHMemberListEmpty', false);
                    }
                    component.set("v.bghContactMebers", responseObj.contactList);
