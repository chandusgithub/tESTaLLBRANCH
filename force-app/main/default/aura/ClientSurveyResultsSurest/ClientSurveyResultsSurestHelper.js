...
**/
({
	getClientSurveySurestRecords : function(component) {
        ...
        var action = component.get("c.getClientSurveySurestRecords");
        ...
        action.setCallback(this,function(response){
            ...
            if(state === 'SUCCESS'){
                ...
                console.log("In getClientSurveySurestRecords method, Failed with state: " + state + " and the Error reason is -> " + response.getError());
            }   
