({
    ...
    getConsultantHistory : function(component) {          
        ...
        consultantHistoryAction.setParams({
            "consultantHistoryId" : component.get('v.consultingHistoryobj.Id')
        });
        consultantHistoryAction.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {    
                ...
                if(consultantHistoryResponseData != null){                    
                    component.set("v.consultingHistoryobj", consultantHistoryResponseData);
                    ...
                    if (errors) {
                        if (errors[0] && errors[0].message) {
                            ...
                            alertEvent.setParams({"errorMessage":errors[0].message});            
                            alertEvent.fire();
                        }
                    } else {
