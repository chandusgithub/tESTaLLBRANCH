({
    enableFields : function(component, event) {
		...
		/*var fieldsToBeEnabled = component.find('visionFields');
    ...
    disableFields : function(component, event) {
		...
		/*var fieldsToBeDisabled = component.find('visionFields');
    ...
    updateAssociatedMedicalCarrierValues : function(component, event) {
        component.set('v.visionData.AssociatedMedicalCarrier__c', component.find("multipleSelect").get("v.value"));
    	/*var compEvent = component.getEvent("competitiveLandscapeEvent");
        compEvent.setParams({'competitorPicklistSelectedVal':component.find("multipleSelect").get("v.value"),'competitorIdToBeUpdated':component.get('v.visionData.CompetitorAccount__r.Id'),'competitorClassificationName':'Vision'});
        compEvent.fire();*/
    },
    
    updateTotalAndPerOfMembers : function(component, event) {
        
        var numberOfMembersHeldVal = component.get('v.visionData.NumberOfMembersHeld__c');
        if(numberOfMembersHeldVal != null && numberOfMembersHeldVal != undefined) {
            ...
            component.set('v.visionData.NumberOfMembersHeld__c', parseInt(valueToBeUpdated));
        } else {
            component.set('v.visionData.NumberOfMembersHeld__c', 0);
        }
        var compEvent = component.getEvent("competitiveLandscapeEvent");
        compEvent.setParams({'isNumberOfMembersHeldChange':true,'competitorClassificationName':$A.get("$Label.c.Vision")});
        compEvent.fire(); 
    },
    
    removeVisionRecords : function(component, event) {
        ...
        var compEvent = component.getEvent("competitiveLandscapeEvent");
        compEvent.setParams({'competitorDataToBeRemoved':component.get('v.visionData'),'index':component.get('v.indexVal')});
        compEvent.fire();
    },
    ...
    showreminderPopUp : function(component, event) {
    	...
    	var compEvent = component.getEvent("competitiveLandscapeEvent");
        compEvent.setParams({'competitorId':component.get('v.visionData.CompetitorAccount__r.Id'),'competitorClassificationName':$A.get("$Label.c.Vision")});
        compEvent.fire();
	},
    
    updatePrimaryIncumbentButtonValue : function(component, event) {
        var compEvent = component.getEvent("competitiveLandscapeEvent");
        compEvent.setParams({'clearOtherPrimaryIncumbents':true,'index':component.get('v.indexVal'),'competitorClassificationName':$A.get("$Label.c.Vision")});
        compEvent.fire();
    },
    
    updateSecondaryIncumbentButtonValue : function(component, event) {
        var compEvent = component.getEvent("competitiveLandscapeEvent");
        compEvent.setParams({'clearOtherPrimaryIncumbents':false,'index':component.get('v.indexVal'),'competitorClassificationName':$A.get("$Label.c.Vision")});
        compEvent.fire();
    },
    ...
    handleMultiPickList : function(component, event) {
        ...
        component.set('v.visionData.AssociatedMedicalCarrier__c',pickListValues);
    },
})