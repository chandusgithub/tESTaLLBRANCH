({
    getObjectType : function(component, event){
        ...
        action.setCallback(this, function(response){
            ...
            if(state == "SUCCESS"){
            	var objType = response.getReturnValue().objectType;
                var roleVals = response.getReturnValue().roleValues;
                //console.log(objType +'---'+roleVals);
                if(objType === 'Contact'){
                 	component.set('v.isContact', true);
                    component.set('v.rolePickListValues', roleVals);
                }
                this.getBusinessGroupsonHealthButton(component,event);
    ...
    getBusinessGroupsonHealth : function(component, event) {
        ...
        if(component.get('v.isContact')){
            ...
            action.setParams({
                "accountId" : component.get('v.recordId'),
                "columnName" : 'BGH_Account__r.Name',
                "sortType" : 'Asc',
                "isContact" : component.get('v.isContact')
        });
        }
        ...
        action.setCallback(this,function(response) {
            ...
            if(state == "SUCCESS") {
                if(component.get('v.isContact')){
                    ...
                    if(response.getReturnValue().accountBusinessGroupsonHealth != null && response.getReturnValue().accountBusinessGroupsonHealth.length > 0) {
    ...
    getBusinessGroupsonHealthButton : function(component, event) {
        if($A.get("$Browser.isIOS")){
            $A.util.removeClass(component.find('articleClass'),'cScroll-table');
        }
        var spinner1 = component.find("spinner");
        ...
        var action = component.get("c.hasBGHeditAccesToThisUser");
        action.setParams({
            "accountId" : component.get('v.recordId'),
            "isContact" : component.get('v.isContact')
        });
        action.setCallback(this,function(response){
            ...
            if(state == "SUCCESS") {
                ...
                $A.util.addClass(spinner2, 'slds-hide');
                $A.util.removeClass(appletIcon, 'slds-hide');
                this.getBusinessGroupsonHealth(component,event);
            } else if (state === "INCOMPLETE") {
                    $A.util.addClass(spinner1, 'slds-hide');
                    $A.util.addClass(spinner2, 'slds-hide');
                    $A.util.removeClass(appletIcon, 'slds-hide');
