({
    ...
    addNewCMAccountHistoryRecord : function(component, event, helper) {
        
        var newCMAccountHistoryData = event.getParam('cmAccountTeamHistoryData1');
        var compEvent = component.getEvent("nationalAccountSalesTeamUserEvent");
        compEvent.setParams({"cmAccountTeamHistoryData2":newCMAccountHistoryData});
        compEvent.fire();
    },
